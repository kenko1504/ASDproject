    ...
    <div 
        ...
        >
          ...
          <div className="bg-[#85BC59] w-8/12 h-10/12 rounded-[10px] shadow-2xl flex flex-col items-center">
            ...
            */}
            {result ? (
                    <div className="p-2 rounded mt-2 w-11/12 h-10/12 overflow-scroll scrollbar-hide">
                      <form action="" className="flex flex-col gap-4">
                        ...
                        {result.data.names?.map((name, index) => (
                          <div key={index} className="flex justify-between py-2 h-1/12 gap-3">
                            <input type="text" defaultValue={name} readOnly className="border rounded w-full flex-2" required/>
                            ...
                            <input type="text" defaultValue={result.data.shoppingDate ? result.data.shoppingDate : ""} className="border rounded w-full flex-1 text-right"  placeholder="Expiry Date" required/>
                          </div>
                        ))}
