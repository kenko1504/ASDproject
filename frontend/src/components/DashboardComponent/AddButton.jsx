...
export default function AddButton() {
  ...
  return (
    <>
      ...
      <button onClick={handleMainButtonClick} className="fixed bottom-6 right-6 w-16 h-16 bg-[#3DC581] text-white rounded-full shadow-lg flex items-center justify-center hover:bg-green-600 active:bg-green-700 transition-colors text-6xl">
        +
      </button>
    </>
  )
