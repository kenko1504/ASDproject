...
export default function AddButton() {
  ...
  return (
    <>
      ...
      {showButtons && 
      <>
        <button onClick={handleManualOpen} className="fixed bottom-24 right-9.5 w-10 h-10 bg-[#36874D] text-white rounded-full shadow-lg flex items-center justify-center hover:bg-green-600 active:bg-green-700 transition-colors text-2xl"><img src={ManualIcon} alt="iconAuto" className="w-6 h-6"/></button>
        <button onClick={handleAutoOpen} className="fixed bottom-35 right-9.5 w-10 h-10 bg-[#36874D] text-white rounded-full shadow-lg flex items-center justify-center hover:bg-green-600 active:bg-green-700 transition-colors text-2xl"><img src={AutoIcon} alt="iconManual" className="w-6 h-6"/></button>
      </>
      }
